...
export default function LandingPage({ preload, onStart }: Props) {
  ...
  return (
    ...
    >
      <h1 className="mx-auto mt-8 mb-4 w-4/7 text-3xl font-medium md:mt-24">
        Welkom bij de digitale Poppenkast
      </h1>
      <p className="mx-auto mb-8 w-4/7">
        Een Webcam AI experiment door{" "}
        <a className="underline" href="https://bfanger.nl/" target="_blank">
          Bob Fanger
        </a>{" "}
        waarbij je door handen voor de Webcam te bewegen de poppen kunt besturen
      </p>
